...
//                            val firstView = homeBanner.getChildAt(0) as RelativeLayout
                            if (!hasShow) {
                            ...
                            if (layoutParams.height < 0 || tempWidth < 0) {
                                ...
                                val relativeLayout = firstView.getChildAt(0) as FrameLayout
                                val viewpager = relativeLayout.getChildAt(0) as ViewPager
        ...
        private fun smoothRecover() {
            ...
            if (originalFirstItemHeight != 0) {
                ...
                val relativeLayout = homeBanner?.getChildAt(0) as FrameLayout
                val viewpager = relativeLayout.getChildAt(0) as ViewPager
                val viewpagerLayoutParams = viewpager.layoutParams
